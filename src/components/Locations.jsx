...
const locationData = [
  {
    ...
    phone: "(305) 123-4567",
    bgImage:
      "url(https://www.digitalsilk.com/wp-content/uploads/2023/12/california.jpg.webp)",
  },
  {
    id: 2,
    number: "02",
    ...
    phone: "(212) 987-6543",
    bgImage:
      "url(https://www.digitalsilk.com/wp-content/uploads/2023/12/new-york.jpg.webp)",
  },
  {
    id: 3,
    number: "03",
    ...
    phone: "(213) 555-7890",
    bgImage:
      "url(https://www.digitalsilk.com/wp-content/uploads/2023/12/chicago.jpg.webp)",
  },
  {
    id: 4,
    number: "04",
    ...
    phone: "(213) 555-7890",
    bgImage:
      "url(https://www.digitalsilk.com/wp-content/uploads/2023/12/miami-1.jpg.webp)",
  },
];
            ...
            >
              {isActive ? (
                <div className="space-y-4  mt-auto mb-10 px-10">
                  <div>
                    <p className="text-4xl font-bold text-[#18CCFC]">
                      {location.number}
                    </p>
