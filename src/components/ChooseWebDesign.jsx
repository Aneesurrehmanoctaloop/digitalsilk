    ...
    <div className="px-16 bg-white py-14">
      <div className="container">
        <div className="grid grid-cols-2 gap-10 ">
          <div className="text-4xl font-bold text-[#1B2C5F]">
            Why Choose <span className="text-[#18CCFC]">Professional</span> Web
            Design Company?
          </div>
          <div className="">
            <img
              src="https://www.digitalsilk.com/wp-content/uploads/2024/09/image-104-1.png.webp"
              alt=""
            />
          </div>
        </div>
